...
function! s:DubsSyn_KeyComboSuffixNoSpell()
  " TRYME:
  "  :echo matchstr('! <Ctrl-x>',           '<\zs\%(Ctrl\|Cmd\|Alt\|Shift\|Meta\|Super\|Enter\|PageUp\|PageDown\|Backspace\|Esc\|Home\|End\|Insert\|Delete\|Tab\|Caps\|Up\|Right\|Down\|Left\|F[1-9]\|F1[0-3]\)>\@=')
  "  :echo matchstr('✓ <Enter>',            '<\zs\%(Ctrl\|Cmd\|Alt\|Shift\|Meta\|Super\|Enter\|PageUp\|PageDown\|Backspace\|Esc\|Home\|End\|Insert\|Delete\|Tab\|Caps\|Up\|Right\|Down\|Left\|F[1-9]\|F1[0-3]\)>\@=')
  "  :echo matchstr('✓ <F1>',               '<\zs\%(Ctrl\|Cmd\|Alt\|Shift\|Meta\|Super\|Enter\|PageUp\|PageDown\|Backspace\|Esc\|Home\|End\|Insert\|Delete\|Tab\|Caps\|Up\|Right\|Down\|Left\|F[1-9]\|F1[0-3]\)>\@=')
  "  :echo matchstr('! <F123>',             '<\zs\%(Ctrl\|Cmd\|Alt\|Shift\|Meta\|Super\|Enter\|PageUp\|PageDown\|Backspace\|Esc\|Home\|End\|Insert\|Delete\|Tab\|Caps\|Up\|Right\|Down\|Left\|F[1-9]\|F1[0-3]\)>\@=')
  syn match KeyComboNoSpellSuffix           '<\zs\%(Ctrl\|Cmd\|Alt\|Shift\|Meta\|Super\|Enter\|PageUp\|PageDown\|Backspace\|Esc\|Home\|End\|Insert\|Delete\|Tab\|Caps\|Up\|Right\|Down\|Left\|F[1-9]\|F1[0-3]\)>\@=' contains=@NoSpell
